...
```
cd existing_repo
git remote add origin https://gitlab.com/Yinebeb-01/simpleapi.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/Yinebeb-01/simpleapi/-/settings/integrations)
